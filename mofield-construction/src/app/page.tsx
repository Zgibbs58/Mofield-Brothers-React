      ...
      {/* <div className="grid grid-o h-100 bg-heroSm md:bg-heroLg"> */}
        ...
        <div className={`text-left flex justify-start w-full pl-6 md:pl-24`}>
          <div className="text-base-100">
            ...
            {/* <Link href={"/contact"} className="text-base-content animate-shimmer bg-primary dark:bg-base-content dark:text-secondary hover:bg-yellow-600 ease-in-out duration-300 rounded-md font-semibold py-1 text-xl px-6 md:text-3xl">Contact Us</Link> */}
            <button>
              <Link href={"/contact"} className="text-base-content animate-shimmer bg-primary dark:bg-base-content dark:text-secondary hover:bg-yellow-600 ease-in-out duration-300 rounded-md font-semibold py-1 text-xl px-6 md:text-3xl">Contact Us</Link>
            </button>
          </div>
        ...
        <section className='px-6 md:px-24 py-48 md:py-64'>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 justify-center items-center gap-10 md:gap-6">
