...
export default function Services() {
  return (
    <main>
        ...
        <section>
          <div className="flex flex-col justify-center md:py-32 md:w-1/2 gap-2 px-6 md:px-12">
