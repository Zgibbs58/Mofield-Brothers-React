  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center py-24 xl:w-1/2 gap-2 px-6 md:px-24">
        ...
        <p className="pt-4">
          Mofield Construction brings decades of experience to every project. From water and sewer installations to precision excavation, directional
          drilling, and efficient dump truck hauling, we deliver unmatched service with reliability and precision. Let's work together to build a
          strong foundation for your next project.
        </p>
      </div>
      <div className="grid lg:grid-cols-2 pb-12 lg:pb-48">
